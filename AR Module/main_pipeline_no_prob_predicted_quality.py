...
df_component_test = pd.read_csv(file_path+"predicted_components_predicted_quality_test_5_labels_complete.csv", header=0, index_col=0)[["text_id", "component_tokens", "predicted_support_quality", "predicted_attack_quality", "labels"]]
...
df_relation_test = pd.read_csv(file_path+"relation_results.csv", header=0, index_col=0)[["text_id", "source_tokens", "target_tokens", "predicted_labels"]]
df_relation_test.rename(columns={"predicted_labels": "labels"}, inplace=True)
